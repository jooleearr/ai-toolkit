...
**1.** Clone this repository into your project as `_ai`:
```bash
git clone <repository-url> _ai
```

**2.** The included `.gitignore` file ensures the `_ai` directory won't be committed to your project repository.

**3.** Reference or copy resources from `_ai` into your project as needed.
...
Organize your resources by type:
...
Keep this repository updated with new resources and improvements discovered during project work. Better prompts and workflows benefit all future projects.
