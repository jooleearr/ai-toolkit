...
## Default instructions to include
- **Spelling** - New Zealand English - no American spelling
- **Commit messages** - Conventional commits format: `type(scope): [Jira Ticket reference] description` (prompt user for ticket code if not provided)
